...
function LiveEventModal({ onClose }) {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        const { fetchLiveEvent } = await import('../../services/api.js')
  ...
  async function handleSave() {
    ...
    try {
      const { saveLiveEvent } = await import('../../services/api.js')
    ...
    <div className="email-agent">
      <div className="page-header">
        ...
        <div className="page-header-right">
          ...
          <button
            className="btn btn-ghost live-event-btn"
            onClick={() => setLiveEventOpen(true)}
            title="Configure current live event info that the AI uses"
          >
            📅 <span className="live-event-btn-label">Live Event</span>
          </button>
          <button
      ...
      {liveEventOpen && (
        <LiveEventModal onClose={() => setLiveEventOpen(false)} />
      )}
